...
### ```Note✨: I have another amazing project on``` [end-to-end-encrypted-chat-application](https://github.com/MrSAGARSINGH) ```using Next.js, Prisma, Postgresql, Express, Socket.io.```
...
![AI Workspace Dashboard](https://raw.githubusercontent.com/MrSAGARSINGH/ai-workspace-dashboard/main/public/images/ai-workspace-home.png)

![AI Workspace Interface](https://raw.githubusercontent.com/MrSAGARSINGH/ai-workspace-dashboard/main/public/images/ai-workspace-dashboard.png)
...
```bash
  git clone https://github.com/MrSAGARSINGH
```
...
## Authors
### Also try -> https://ai-workspace-dashboard-omega.vercel.app

### Note✨: Explore my portfolio website

[Portfolio Website](https://sagar-portfolio-ix1v.vercel.app)
...
Portfolio: https://sagar-portfolio-ix1v.vercel.app

Project Repository: https://github.com/MrSAGARSINGH/ai-workspace-dashboard
